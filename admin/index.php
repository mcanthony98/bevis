...
<head>
  ...
  <title>Admin Panel | Kiliki Beekeepers</title>
        ...
        <div class="row">
          <div class="col-lg-6 mx-auto pt-5">
            <div class="mt-5 text-center">
              <img src="../assets/images/kiliki-logo-light.png" alt="Logo" class="brand-image" style="max-width:170px;" style="opacity: .8"><br>
