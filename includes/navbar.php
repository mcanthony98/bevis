		...
		<div class="container">
			<div class="row position-relative">
				<div class="col-md-8 mx-auto py-5">
					...
					<p class="small mt-2 mb-0"><strong>e.g.</strong>Carbon Credits, Regenerative Agriculture, Blue Carbon</p>
				</div>
		...
		<div class="container">
			<div class="d-flex justify-content-between align-items-center">
				...
				<div class="d-flex align-items-center">
					...
					<ul class="nav list-unstyled ms-3">
						<li class="nav-item me-3">
							<a class="navbar-link" href="#"><strong>Phone:</strong> 0703145010 / 0726314189</a>
						</li>
						<li class="nav-item me-3">
							<a class="navbar-link" href="#"><strong>Email:</strong> info@bevisafrica.com</a>
						</li>
					</ul>
				</div>
				...
				<div class="d-flex align-items-center">
					...
					<ul class="nav">
						<li class="nav-item">
							<a class="navbar-link mx-3" href="contact.php">Contact</a>
						</li>
					</ul>
					<!-- top social -->
