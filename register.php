			...
			<div class="row">
				...
				<div class="col-12 col-md-5 col-lg-4 d-md-flex align-items-center bg-grad vh-sm-100">
					<div class="w-100 p-3 p-lg-5 all-text-white">
						...
						<h3 class="fw-light">We connect you with the world largest community</h3>
					...
					<div class="row h-100">
						<div class="col-12 col-md-10 col-lg-5 text-start mx-auto d-flex align-items-center">
							<div class="w-100">
								...
								<h5 class="fw-light">Join us today! Create your account easy with less information.</h5>
								<div class="form mt-4 ">
									<div>
    								...
    								<label class="form-check-label ms-2" for="exampleCheck1">By signing up, you agree to the <a href="#">terms of service</a></label>
									</div>
									<div class="row align-items-center g-0 m-0">
										<div class="col-6"><span class="text-muted">Already on wizixo? <a href="sign-in.html">Sign in</a></span></div>
